...
//        log.info(moduleBaseURL.toString()); // http://localhost:8080/module1/
//        log.info(strongName); // 3BB7E0695CABFD07F9049C9DF4824C13
//        
//        
//        log.info(ServletUriComponentsBuilder.fromCurrentContextPath().build().toUriString());
//        
//        //return super.doGetSerializationPolicy(request, moduleBaseURL, strongName);
...
//        
//        
//        String serializationPolicyFilePathFoo = SerializationPolicyLoader
//                .getSerializationPolicyFileName(moduleBaseURL + strongName);
//        servlet.log("FOOOOOOOOOO****: "+serializationPolicyFilePathFoo);
//
//
